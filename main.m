...
%% Ming Li (A Generalized Universal formula with norm bounded constraints) kappa_5
for i=1:size(Initial_position,2)
    [T,x_Ming_kappa5(:,:,i)] = ode45(@odefcn_Ming_kappa5,[0:0.01:t_end],Initial_position(:,i));
end
flag =7;   % kappa choice
[u_kappa5_save] = Input_Compute(x_Ming_kappa5,flag);
